...
#       taints              = include.env.locals.global_vars.locals.aks.node_pools.aiqxcore.taints
#       labels              = include.env.locals.global_vars.locals.aks.node_pools.aiqxcore.labels
