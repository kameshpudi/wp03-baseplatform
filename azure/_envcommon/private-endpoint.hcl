...
dependency "acr" {
  ...
  mock_outputs = {
    private_connection_resource_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/d-weu-aiqx-network-rg/providers/microsoft.network/privateendpoints/pvte-endpoint"
  }
...
dependency "rg" {
  ...
  # resources. More information can be found here https://terragrunt.gruntwork.io/docs/features/execute-terraform-commands-on-multiple-modules-at-once/#dependencies-between-modules
  mock_outputs = {
    rg_name = "MOCK-aiqx-app-network-rg"
  }
}
