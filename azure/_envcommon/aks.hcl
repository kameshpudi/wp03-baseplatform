...
dependency "rg" {
  ...
  mock_outputs = {
    rg_name = "MOCK-test-app-compute-rg"
  }
}
...
dependency "loga" {
  ...
  mock_outputs = {
    log_analytics_ids = {
    "${local.mock_log_analytics_name}" = "/subscriptions/sdgg11-5653-4822-b4dd-33sdasf456f1/resourcegroups/dummy-rg/providers/microsoft.operationalinsights/workspaces/dummy-workspace" }
  }
}
...
inputs = {
  ...
  dns_prefix                   = "test-${local.config_vars.locals.stage}"
